...
def test_successful_registration(driver, fill_out_registration_form):
    user = NewUser()
...
def test_registration_with_short_password(driver, fill_out_registration_form, password):
    user = NewUser()
    driver.get(REGISTRATION_PAGE_URL)
